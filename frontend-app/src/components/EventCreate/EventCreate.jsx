		...
		<form className="event-form" onSubmit={handleSubmit}>
			...
			{generatedLinks && (
				<div className="generated-links">
					<h3>Ссылки на мероприятие:</h3>
					<p>Ссылка для регистрации: {generatedLinks.register}</p>
					<p>Код анкеты: {generatedLinks.link}</p>
					<p>Ссылка на результаты анкеты: {generatedLinks.results}</p>
				</div>
			)}
